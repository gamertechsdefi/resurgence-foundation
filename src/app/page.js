  ...
  return (
    <div style={{ fontFamily: 'Montserrat, sans-serif' }}>
          ...
          <div className="flex  flex-col justify-center z-10 bg-neutral-900 h-[100%] bg-opacity-60 text-white">
            <div className="p-8 md:p-16 md:w-[50%]">
              ...
              <div className="flex gap-8">
                <Link className="bg-red-600 p-4 rounded-lg shadow-sm font-bold" href="">Donate</Link>
                <Link className="bg-[#f9f9f9] text-black p-4 rounded-lg shadow-sm font-bold" href="https://bit.ly/4hfhDYq">Learn More </Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-neutral-200 border-2 border-neutral-500 rounded-lg p-4">
              <div className="flex flex-row items-center gap-2 pb-2">
                <svg className="w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#000000" d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z" /></svg>
            ...
            <div className="bg-neutral-200 border-2 border-neutral-500 rounded-lg p-4">
              <div className="flex flex-row items-center gap-2 pb-2">
              <svg className="w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#000000" d="M480 32c0-12.9-7.8-24.6-19.8-29.6s-25.7-2.2-34.9 6.9L381.7 53c-48 48-113.1 75-181 75l-8.7 0-32 0-96 0c-35.3 0-64 28.7-64 64l0 96c0 35.3 28.7 64 64 64l0 128c0 17.7 14.3 32 32 32l64 0c17.7 0 32-14.3 32-32l0-128 8.7 0c67.9 0 133 27 181 75l43.6 43.6c9.2 9.2 22.9 11.9 34.9 6.9s19.8-16.6 19.8-29.6l0-147.6c18.6-8.8 32-32.5 32-60.4s-13.4-51.6-32-60.4L480 32zm-64 76.7L416 240l0 131.3C357.2 317.8 280.5 288 200.7 288l-8.7 0 0-96 8.7 0c79.8 0 156.5-29.8 215.3-83.3z"/></svg>
      ...
      <footer className="flex flex-col md:flex-row justify-between px-8 py-16 md:px-16 gap-4">
        ...
        <svg className="w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#000000" d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm297.1 84L257.3 234.6 379.4 396H283.8L209 298.1 123.3 396H75.8l111-126.9L69.7 116h98l67.7 89.5L313.6 116h47.5zM323.3 367.6L153.4 142.9H125.1L296.9 367.6h26.3z"/></svg>
        </a>
        </div>
      </footer>
    </div>
